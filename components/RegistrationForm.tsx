          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-fade-in border-t-8 border-t-blue-700">
            ...
            <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl mb-6">
              ...
              <div className="flex items-center gap-3">
                <span className="text-lg font-black text-gray-800 bg-white px-4 py-2 rounded-lg border border-gray-200 shadow-sm">
                  {num1} + {num2} =
                </span>
                <input
                  type="number"
                  ...
                  placeholder="?"
                  className="w-20 border-2 border-gray-200 p-2 rounded-lg text-lg font-black text-center focus:border-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700/20"
                />
              </div>
            ...
            <div className="flex gap-3 mt-auto">
              <button 
                ...
                className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-black py-3 rounded-xl transition-colors uppercase text-sm tracking-widest"
              >
                Cancel
              </button>
              <form action={verifyAndSubmit} className="flex-1 flex">
                ...
                <SubmitButton 
                  ...
                  className="w-full bg-blue-700 hover:bg-blue-800 text-white font-black py-3 rounded-xl transition-colors uppercase text-sm tracking-widest"
                >
                  I Consent
                </SubmitButton>
              </form>
